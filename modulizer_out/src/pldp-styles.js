...
$_documentContainer.innerHTML = `<dom-module id="pldp-styles">
  <template>
    <style>
      .card {
        margin: 0px 12px;
        ...
        box-shadow: 0px 2px 8px 0px rgba(46,61,73,0.2);
      ...
      .action-container > div:nth-child(even){
      ...
      paper-tabs {
        ...
        --paper-tabs-selection-bar: border: 6px solid #009688;
        z-index: 1000;
        width: 100%;
