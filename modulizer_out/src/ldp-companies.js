...
class Companies extends Element {
  static get template() {
    return html`
    <style include="w3-styles"></style>
      ...
      <firebase-query id="qrycompany" path="/companies" order-by-child="companyID" data="{{companies}}">
      </firebase-query>
      ...
      <div class="ldp-modal" id="addCompanyForm">
        <div class="ldp-modal-content w3-round" style="max-width:600px">
            <span class="w3-display-topright w3-deep-orange w3-padding w3-large" on-tap="closeModal">×</span>
...
`;
  ...
  closeModal(e){
    ...
    this.clearAddForm();
    var modal = dom(this.root).querySelector('#addCompanyForm');
