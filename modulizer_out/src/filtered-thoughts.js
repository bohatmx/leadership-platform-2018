...
class FilteredThoughts extends Element {
  static get template() {
    return html`
    <style>
  ...
  <view-thoughts user="[[user]]" _companyid="[[_companyid]]" thoughtype="filteredthoughts" filterid="[[filterid]]" placeholder="Search for Messages"></view-thoughts>
`;
  }

  static get is() { return 'filtered-thoughts'; }
...
window.customElements.define(FilteredThoughts.is, FilteredThoughts);
